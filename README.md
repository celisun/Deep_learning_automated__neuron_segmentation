...
- Reproduced and used **residual network method**. (original: https://arxiv.org/abs/1512.03385, implementation on github: https://github.com/gcr/torch-residual-networks). This has been giving me a great boost in classificaiton results. It was found in the preliminary experiments that training with a 5-7-5 window for the three conv layers in each block of residual net on a sample size of 127*127 outformed by a large margin the originally proposed 1-3-1 structure, so the experiments reported above were using the 5-7-5 window.
